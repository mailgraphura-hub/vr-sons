...
export default function MyInquiries() {
  ...
  const getStatusStyle = (status) => {
    switch (status) {
      case "Open":
        return {
          pill: "bg-sky-50 text-sky-500 border border-sky-200",
          dot: "bg-sky-400",
        };
      case "Processing":
        return {
      ...
      default:
        return { pill: "bg-stone-100 text-stone-500", dot: "bg-stone-400" };
    }
  };
          ...
          selectedInquiry ? (
            <>
              ...
              <div
                ...
                style={{ borderLeft: "4px solid #c97b5a" }}
              >
                <h2 className="text-xl md:text-2xl font-bold mb-6 text-stone-800">
                ...
                <div className="mt-6">
                  {(() => {
                    ...
                    return (
                      <span
                        className={`inline-flex items-center gap-2 px-4 py-2 rounded-full text-sm font-medium ${s.pill}`}
                      >
                        <span
          ...
          <>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-3">
              <div>
                ...
                <p className="text-stone-400 text-sm mt-1">
                  Track and manage all your submitted inquiries
                </p>
              </div>
              <div
                className="self-start sm:self-auto px-5 py-2 rounded-2xl font-semibold text-sm shadow-sm whitespace-nowrap"
            ...
            <div className="flex flex-col sm:flex-row gap-3 mb-6">
              <select
                ...
                className="w-full sm:w-48 px-4 py-2.5 rounded-xl border border-stone-200 bg-white text-stone-600 text-sm font-medium shadow-sm focus:outline-none"
              >
              ...
              <input
                ...
                className="w-full sm:flex-1 px-4 py-2.5 rounded-xl border border-stone-200 bg-white text-stone-600 text-sm shadow-sm focus:outline-none focus:ring-2"
                style={{ focusRingColor: "#c97b5a" }}
              />
            </div>
            ...
            {loading ? (
              <div className="flex justify-center items-center py-20">
                <div
                  className="w-8 h-8 rounded-full border-4 border-stone-200 animate-spin"
                  style={{ borderTopColor: "#c97b5a" }}
                />
              </div>
            ) : filteredInquiries.length === 0 ? (
              <div className="bg-white rounded-3xl py-20 text-center text-stone-400 text-sm shadow-sm">
                No Inquiries Found
              </div>
            ) : (
              <>
                ...
                <div className="hidden md:block bg-white rounded-3xl overflow-hidden shadow-sm">
                  ...
                  <div
                    ...
                    style={{
                      gridTemplateColumns: "2.5fr 1fr 1.2fr 1fr 0.8fr",
                  ...
                  {filteredInquiries.map((item) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <div>
                          <span
                            className={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold ${s.pill}`}
                          >
                            <span
                        ...
                        <div className="text-center">
                          <button
                            onClick={() =>
                              navigate(`/user/inquiries/inquiry-Detial`, {
                                state: { data: item },
                              })
                            }
                ...
                <div className="flex md:hidden flex-col gap-3">
                  {filteredInquiries.map((item) => {
                    ...
                    return (
                      ...
                      >
                        {/* Card Top: Avatar + Company + Status */}
                        <div className="flex items-center justify-between gap-3 mb-3">
                          ...
                          <span
                            className={`flex-shrink-0 inline-flex items-center gap-1.5 px-3 py-1 rounded-full text-xs font-semibold ${s.pill}`}
                          >
                            <span
                              className={`w-1.5 h-1.5 rounded-full ${s.dot}`}
                            ></span>
                        ...
                        <div className="flex items-center justify-between text-sm mt-1">
                          ...
                          <button
                            ...
                            className="px-5 py-2 text-white rounded-xl text-xs font-semibold hover:opacity-90 active:scale-95 transition-all shadow-sm"
                            style={{ backgroundColor: "#c97b5a" }}
                          >
                            View
                          </button>
            ...
            {totalPages > 1 && (
              <div className="flex justify-center items-center gap-2 mt-8 flex-wrap">
                <button
                  ...
                  className="px-4 py-2 border border-stone-200 rounded-xl bg-white text-stone-600 text-sm font-medium hover:bg-stone-50 disabled:opacity-40 transition shadow-sm"
                >
                  ← Prev
                </button>
